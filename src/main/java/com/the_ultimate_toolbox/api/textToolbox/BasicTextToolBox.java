package com.the_ultimate_toolbox.api.textToolbox;
...
public class BasicTextToolBox {
    ...
    /**
     * Initializes a string array of a given size with empty strings.
     *
 ...
 i++) {
    ...
    /**
     * Checks if a given string contains only letters or not.
